...
class CreateExercise extends Component {
    ...
    saveExercise = (e) => {
      ...
      ExcercisesServices.getExerciseMax().then(r=>{
        ExcercisesServices.addExerciseToGroup(r.data.id_ejercicio,sessionStorage.getItem("idGrupo"));
      })
            ...
            <div className='card-body'>
              ...
              <form>
                <div className='form-group'>
                  ...
                  <input placeholder='Primer ecucación' name='Ec1' className='form-control'
                  onChange={this.changeEc1Handler}/>
                </div>
                <div className='form-group'>
                  <label>Ecuación 2</label>
                  <input placeholder='Segunda ecuación' name='Ec2' className='form-control'
